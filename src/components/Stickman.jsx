...
const Stickman = ({ pose = 'hold', chargeLevel = 0 }) => {
  ...
  return (
    ...
    >
      {/* 머리 */}
      <circle cx="40" cy="20" r="16" stroke="#191919" strokeWidth="3.5" fill="none" />

      {/* 몸통 */}
      <line x1="40" y1="36" x2="40" y2="85" stroke="#191919" strokeWidth="3.5" strokeLinecap="round" />
      ...
      {pose === 'hold' || pose === 'charge' || pose === 'throw' ? (
        <>
          ...
          <line
            ...
            stroke="#191919" strokeWidth="3.5" strokeLinecap="round"
          />
          {/* 왼팔 - 자연스럽게 */}
          <line x1="40" y1="55" x2="18" y2="75" stroke="#191919" strokeWidth="3.5" strokeLinecap="round" />
        </>
      ) : (
        <>
          {/* 걷기 팔 */}
          <line x1="40" y1="55" x2="18" y2="72" stroke="#191919" strokeWidth="3.5" strokeLinecap="round" />
          <line x1="40" y1="55" x2="62" y2="72" stroke="#191919" strokeWidth="3.5" strokeLinecap="round" />
        </>
      )}
      ...
      <line
        ...
        stroke="#191919" strokeWidth="3" strokeLinecap="round"
      />
      <line
